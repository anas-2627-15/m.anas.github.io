...
- **Languages:** Python, C#  
- **Database:** MySQL  
- **Tools:** GitHub, VS Code, Microwind,My SQL and Visual studio committie ide  
- **Concepts:** OOP, DLD, Basic ML Model Training and PF 
...
- Gained confidence in handling programming and circuit-based tasks  
- Learned to connect theoretical knowledge with practical applications  
...
- Building real-world and impactful projects  
